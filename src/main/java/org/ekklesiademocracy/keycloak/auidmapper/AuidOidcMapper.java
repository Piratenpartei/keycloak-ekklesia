package org.ekklesiademocracy.keycloak.auidmapper;
...
public class AuidOidcMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {

    private static final String PROVIDER_ID = "oidc-simple-protocol-mapper";

    private static final Logger LOGGER = Logger.getLogger(AuidOidcMapper.class);
